...
public class Data {
    ...
    if(NumberOfInputs == 7){
        this.TRAINING_DATA = new double [][][] {{{1,0.000, 0.000,0.000, 0, 0, 0, 0},{0.000,0.000,0.000}},
                {{1, 0.111, 0.111, 0.111, 0.111, 0.111, 0.111, 0.111},{0.010,0.026,0.005}},
                {{1, 0.222, 0.222, 0.222, 0.222, 0.222, 0.222, 0.222},{0.031,0.073,0.017}},
                {{1, 0.333, 0.333, 0.333, 0.333, 0.333, 0.333, 0.333},{0.069,0.142,0.042}},
                {{1, 0.444, 0.444, 0.444, 0.444, 0.444, 0.444, 0.444},{0.130,0.231,0.088}},
                {{1, 0.556, 0.556, 0.556, 0.556, 0.556, 0.556, 0.556},{0.220,0.342,0.164}},
                {{1, 0.667, 0.667, 0.667, 0.667, 0.667, 0.667, 0.667},{0.350,0.475,0.279}},
                {{1, 0.778, 0.778, 0.778, 0.778, 0.778, 0.778, 0.778},{0.514,0.629,0.448}},
                {{1, 0.889, 0.889, 0.889, 0.889, 0.889, 0.889, 0.889},{0.730,0.804,0.683}},
                {{1,1.00,1.00,1.00, 1.00, 1.00, 1.00, 1.00},{1,1,1}}};

        this.TESTING_DATA = new double [][][] {{{1, 0.4,0.4,0.4, 0.4, 0.4, 0.4, 0.4}, {0,0,0}},
                {{1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5}, {0,0,0}},
                {{1, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6}, {0,0,0}}};
    }
